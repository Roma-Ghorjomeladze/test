...
Gutschine.getInitialProps = async function(ctx) {
  ...
  const content = await import(`../../../data/angebot/trauma-arbeit/${slug}.md`)
  const config = await import(`../../../data/angebot/trauma-arbeit/config.json`)
  const data = matter(content.default)

  return {
    markdownFile: {
      fileRelativePath: `data/angebot/trauma-arbeit/${slug}.md`,
