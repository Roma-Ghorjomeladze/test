...
Andrea.getInitialProps = async function() {
  const content = await import(
    '../../../data/angebot/prantalTherapie/config.json'
  )
  let records = (context => {
    ...
    return data
  })(require.context('../../../data/angebot/prantalTherapie', true, /\.md$/))
  return {
    jsonFile: {
      fileRelativePath: `data/angebot/prantalTherapie/config.json`,
