          ...
          <ArticleCont key={record.slug}>
            <Article
              ...
              record={{
                ...
                dir: 'angebot/craniosacral-therapie/schwangerschaft',
              }}
            />
          </ArticleCont>
        ))}
...
Scwangerschaft.getInitialProps = async function() {
  ...
  let records = (context => {
    ...
    require.context(
      '../../../../data/angebot/craniosacral-therapie/schwangerschaft',
      true,
      /\.md$/
    )
  )
  return {
    jsonFile: {
      fileRelativePath: `data/angebot/craniosacral-therapie/schwangerschaft/config.json`,
