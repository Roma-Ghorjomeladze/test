          ...
          <ArticleCont>
            <Article
              ...
              record={{
                ...
                dir: '/angebot/craqniosacralTherapie/kinderUndFamilien',
              }}
            />
          </ArticleCont>
        ))}
...
Andrea.getInitialProps = async function() {
  ...
  let records = (context => {
    ...
    require.context(
      '../../../../data/angebot/craniosacralTherapie/kinderUndFamilien',
      true,
      /\.md$/
    )
  )
  return {
    jsonFile: {
      fileRelativePath: `data/angebot/craniosacralTherapie/kinderUndFamilien/config.json`,
