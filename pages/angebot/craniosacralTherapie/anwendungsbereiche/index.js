          ...
          <ArticleCont>
            <Article
              ...
              record={{
                ...
                dir: 'angebot/craniosacralTherapie/anwendungsbereiche',
              }}
            />
          </ArticleCont>
        ))}
...
Andrea.getInitialProps = async function() {
  ...
  let records = (context => {
    ...
    require.context(
      '../../../../data/angebot/craniosacralTherapie/anwendungsbereiche',
      true,
      /\.md$/
    )
  )
  return {
    jsonFile: {
      fileRelativePath: `data/angebot/craniosacralTherapie/anwendungsbereiche/config.json`,
