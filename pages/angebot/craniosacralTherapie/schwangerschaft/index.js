          ...
          <ArticleCont>
            <Article
              ...
              record={{
                ...
                dir: '/angebot/craqniosacralTherapie/schwangerschaft',
              }}
            />
          </ArticleCont>
        ))}
...
Andrea.getInitialProps = async function() {
  const content = await import(
    '../../../../data/angebot/craniosacralTherapie/schwangerschaft/config.json'
  )
  let records = (context => {
    ...
    require.context(
      '../../../../data/angebot/craniosacralTherapie/schwangerschaft',
      true,
      /\.md$/
    )
  )
  return {
    jsonFile: {
      fileRelativePath: `data/angebot/craniosacralTherapie/schwangerschaft/config.json`,
