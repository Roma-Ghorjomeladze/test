          ...
          <ArticleCont>
            <Article
              ...
              record={{
                ...
                dir: '/angebot/craqniosacralTherapie/nachDerGeburt',
              }}
            />
          </ArticleCont>
        ))}
...
Andrea.getInitialProps = async function() {
  const content = await import(
    '../../../../data/angebot/craniosacralTherapie/nachDerGeburt/config.json'
  )
  let records = (context => {
    ...
    require.context(
      '../../../../data/angebot/craniosacralTherapie/nachDerGeburt',
      true,
      /\.md$/
    )
  )
  return {
    jsonFile: {
      fileRelativePath: `data/angebot/craniosacralTherapie/nachDerGeburt/config.json`,
